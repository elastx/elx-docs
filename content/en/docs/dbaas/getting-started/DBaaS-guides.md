...
4. Resources: Select type of instance to be used with your datastore.   
    ...
    Upon choosing 'Volumes', you will have the options of 'Dynamic', '16k IOPS', or '8k IOPS' as available volume types. Lastly if volume storage is chosen, you can specify the desired size of the disk.
