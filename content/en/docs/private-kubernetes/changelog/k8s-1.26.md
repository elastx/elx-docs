...
Current release is Kubernetes 1.26.6

## Major changes
  * Support for node autoscaling is added
  * Flow control resources `flowcontrol.apiserver.k8s.io/v1beta1` removed. The replacement `flowcontrol.apiserver.k8s.io/v1beta2` was implemented in Kubernetes 1.23
  * HorizontalPodAutoscaler `autoscaling/v2beta2` removed. The replacement `autoscaling/v2` was introduced in Kubernetes 1.23
