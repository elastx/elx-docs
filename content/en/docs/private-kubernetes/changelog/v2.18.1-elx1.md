...
* Several old APIs are now longer served. [A complete list can be found in Kubernetes documentation](https://kubernetes.io/docs/reference/using-api/deprecation-guide/#v1-22)
